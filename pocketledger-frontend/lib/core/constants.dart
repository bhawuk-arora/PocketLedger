class AppConstants {
  static const String supabaseUrl = 'https://oqpmswwvygwkmeztjsyk.supabase.co';
  ...
  static const String backendUrl = 'http://10.0.2.2:8000'; // Change to real URL in production

  // Paste your Resend API Key here to enable sending reports directly from the app
  static const String resendApiKey = '';
}
